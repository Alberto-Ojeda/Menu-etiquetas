...
import Vista.vistaExtraerEtiquetas;
...
public class controladorExtraerEtiquetas implements ActionListener {
    ...
    public controladorExtraerEtiquetas(vistaExtraerEtiquetas vistaEx, modeloEtiquetas modeloEx) {
        this.vistaEx = vistaEx;
        this.vistaEx.importar.addActionListener(this);
        this.vistaEx.mercado2.addActionListener(this);
    }
    ...
    public void importar() throws IOException, DocumentException, PrinterException {
        if (selecArchivo.showDialog(null, "Crear") == JFileChooser.APPROVE_OPTION) {
            ...
            if (archivo.getName().endsWith("pdf")) {
                ...
                modeloEx.importarT(archivo, vistaEx.tablapdf);
                modeloEx.addCheckBox(archivo, vistaEx.tablapdf);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == vistaEx.importar) {
            try {
                importar();
            } catch (IOException ex) {
                Logger.getLogger(controladorExtraerEtiquetas.class.getName()).log(Level.SEVERE, null, ex);
        ...
        if (e.getSource()== vistaEx.mercado2) {
            try {
                importar2();
           } catch (IOException ex) {
                Logger.getLogger(controladorExtraerEtiquetas.class.getName()).log(Level.SEVERE, null, ex);
